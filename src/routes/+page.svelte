	...
	<div class="mx-auto max-w-7xl px-4">
		...
		>
			<div class="flex w-full flex-col items-center gap-6">
				...
				<div
					class="pointer-events-none flex select-none flex-col items-center gap-4"
				>
					<a href="/home" class="pointer-events-auto no-underline">
						<Label
							class="cursor-pointer text-7xl font-bold"
							style="font-family: 'LinLibertine'">Bliptext</Label
						>
					</a>
					<Label class="text-sm sm:text-xl">
						A wiki where you can edit <span class="text-primary"
							>one word</span
						> every 30 seconds.
					</Label>
				</div>
				...
				>
					<div class="flex flex-col items-center gap-2">
						<div
							class="flex items-center justify-center gap-1 text-sm text-foreground"
						>
							...
							>
								<span
									class="flex items-center rounded-md bg-primary/50 px-2 py-1 font-bold"
								>
									<img
